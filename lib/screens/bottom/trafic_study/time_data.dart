        ...
        child: Center(
          child: DataTable(
            ...
            rows: [
              ...
              DataRow(cells: [
                const DataCell(Text('Tiempo de acel. y desacel simultaneos:')),
              ...
              DataRow(cells: [
                const DataCell(Text('Tiempo de apertura y cierre de puertas:')),
                DataCell(Text(valueProvider.doorOpeningAndClosingTime)),
              ]),
              DataRow(cells: [
                const DataCell(Text('Tiempo de entrada y salida de pasajeros:')),
