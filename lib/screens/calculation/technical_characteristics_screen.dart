...
class TechnicalCharacteristicsScreen extends StatefulWidget {
  const TechnicalCharacteristicsScreen({super.key});

  @override
  State<TechnicalCharacteristicsScreen> createState() =>
      _TechnicalCharacteristicsScreenState();
}

class _TechnicalCharacteristicsScreenState
    extends State<TechnicalCharacteristicsScreen> {
