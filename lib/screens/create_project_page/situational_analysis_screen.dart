...
class SituationalAnalysisScreen extends StatelessWidget {
  final Map<String, dynamic> data;
  const SituationalAnalysisScreen({Key? key, required this.data})
      : super(key: key);
                      ...
                      DataTable(
                        ...
                        rows: [
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(Text(
                                '${data["travel_time_for_express_floors"]}')),
                          ]),
                          DataRow(cells: [
                            const DataCell(
                          ...
                          DataRow(cells: [
                            const DataCell(Text(
                                'Tiempo de apertura y cierre de puertas:')),
                            DataCell(Text(
                                '${data["door_opening_and_closing_time"]}')),
                          ]),
                          DataRow(cells: [
                            const DataCell(Text(
                                'Tiempo de entrada y salida de pasajeros:')),
                            DataCell(Text(
                                '${data["passenger_entry_and_exit_time"]}')),
                          ]),
                          DataRow(cells: [
